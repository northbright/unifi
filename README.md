...
Package unifi provides [UBNT](https://www.ubnt.com/) [Unifi](https://unifi-sdn.ubnt.com/) APIs to interact with Unifi Controller. It's written in [Golang](https://golang.org).
